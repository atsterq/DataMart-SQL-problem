-- 2.2 
-- анализ различий rd.deal, rd.product
...
-- deal
select -- сколько записей в rd / в csv из data
	( select count(1) from rd.deal_info as di3) as rd_deal_count
	, ( select count(1) from data.deal_info as di ) as data_deal_count;

select count(1) from ( -- полных совпадений нет
